...
-   Office hours: See [Moodle](https://moodle.reed.edu/course/view.php?id=6317) for weekly office hour times and locations. I am also happy to meet by appointment if you have conflicts during the scheduled times. Please [email me](mailto:meganayers@reed.edu) or send me a Slack message to find a time to meet. 

**Course Assistants**: We have course assistants for Math 141 this semester. A course assistant will be present at each lab section. Further, each course assistant will hold office hours during the week. Times and locations of course assistant office hours can be found on [Moodle](https://moodle.reed.edu/course/view.php?id=6317). Feel free to go to any course assistant's office hours, even if they are not the course assistant for your lab section. 


**Links and course resources**:

The course website, [megan-k-ayers.github.io/math-141-sp26](https://megan-k-ayers.github.io/math-141-sp26/), includes information on the course, lecture slides, public course materials, and links to all other course resources:
...
-   [Moodle](https://moodle.reed.edu/course/view.php?id=6317), (sparingly) for information about meetings and private course materials


**Meeting Times**:

We'll have a lecture-style meeting three times a week, and a lab meeting once a week. Please see the course [Moodle](https://moodle.reed.edu/course/view.php?id=6317) page or the [Reed schedule of classes](https://solar.reed.edu/class_schedule/) to verify the times and locations for your section.
...
-   **Exams**:
    ...
    - The final exam slot is tentatively scheduled for:
        - *S01, S02, and S03*: Monday, May 11 from 6-9pm
        - *S11, S12, and S13*: Thursday, May 14 from 9am-12pm
