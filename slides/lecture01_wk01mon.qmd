...
2.  Getting started in Math 141
    i.  Course structure and technologies
    ii. Where to find resources
    iii. Course expectations
3.  Introduce statistical thinking
4.  Introduce data frames
:::
...
-   Name
-   Pronouns 
-   Share something you're excited about for this semester (Reed-related or not)
:::
...
Goal 2: Getting Started in Math 141
:::
...
::: {.column width="40%"}
-   The course website, [math-141-sp26.github.io](https://math-141-sp26.github.io/), will be the central location for all our course materials.
...
- The Math 141 Teaching Team are so excited to support your learning!
...
::: {.fragment .midi}
![](img/GAcovid2.jpg){fig-align="center" width="60%"}
:::
...
::: {.fragment .midi}
![](img/GAcovid2.jpg){width="50%"} ![](img/GAcovid_cairo.png){width="40%"}
:::
