...
```{r}
not_fred <- filter(dogs, Dog_Name != "Freddy")
head(not_fred)
```
:::
...
Why does the mean income value change between these approaches, even though there are no NA income values?
...
::: {.fragment}
**Write pseudocode to answer**: what states in the west have the highest average mobility rate across their private and elite colleges? 
:::
